...
public class MBKClusterUpdating {
    ...
    ObjectsInforListKP objectsInforListKP;  //移动对象位置点信息表
    int eps; //聚类半径
    int minpts; //聚类密度
    int mc;  ////成员数量阈值
    ...
    HashMap<String, ObjectInforNodeKP> exCores;  //前核心点集
    HashMap<String, ObjectInforNodeKP> neoCores;  //新核心点集
    HashMap<String, ObjectInforNodeKP> incOINs;  //用于记录所有新增点的信息
