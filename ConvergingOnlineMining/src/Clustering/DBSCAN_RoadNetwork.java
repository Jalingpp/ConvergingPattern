...
public class DBSCAN_RoadNetwork {
     ...
     * @return
     */
    public static HashMap<String, Cluster> getClusters(HashMap<String, SnapObject> snapshotObjectSet, RNRangeQuery rnRQ, int minpts, String timeStamp, int mc) {
        int idnum = 0;   //表示簇的id
        Boolean flag = true;
...
//        ts = System.currentTimeMillis();
        do {
            flag = false;
            idnum++;
            Cluster cluster = new Cluster(String.valueOf(idnum), timeStamp);
